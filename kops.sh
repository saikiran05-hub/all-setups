...
kops create cluster --name sai.k8s.local --zones us-east-1a --master-count 1 --master-size t2.medium --master-volume-size 25 --node-count 2 --node-size t2.micro --node-volume-size 20
